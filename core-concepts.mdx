...
Free plans are limited to two environments (development and live). Paid plans allow the creation of as many environments as needed. For example, you may have:
